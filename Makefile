.PHONY: test bootstrap bundle clean serve sync digest harvest-discussions help
...
harvest-discussions: ## Harvest Discussions REST data into state/discussions/ (Static Data Covenant)
	python scripts/harvest_discussions.py
